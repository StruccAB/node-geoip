...
if (typeof global.geodatadir === 'undefined'){
	...
	geodatadir = path.join(process.cwd(), '/node_modules/node-geoip/data/'); // deployed
	geodatadir = path.join(process.cwd(), '/../../node_modules/node-geoip/data/'); // local
	geodatadir = path.join(__dirname, '/../../../node_modules/node-geoip/data/'); // deployed
	geodatadir = path.join(appDir, '/../../../node_modules/node-geoip/data/'); // local
	*/
	geodatadir = path.join(process.cwd(), '/node_modules/node-geoip/data/'); // deployed
} else {
