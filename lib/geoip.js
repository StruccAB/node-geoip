...
if (typeof global.geodatadir === 'undefined'){
	...
	geodatadir = path.join(process.cwd(), '/node_modules/geoip-lite/data/'); // deployed
	geodatadir = path.join(process.cwd(), '/../../node_modules/geoip-lite/data/'); // local
	geodatadir = path.join(__dirname, '/../../../node_modules/geoip-lite/data/'); // deployed
	geodatadir = path.join(appDir, '/../../../node_modules/geoip-lite/data/'); // local
	*/
	geodatadir = path.join(process.cwd(), '/node_modules/geoip-lite/data/'); // deployed
} else {
